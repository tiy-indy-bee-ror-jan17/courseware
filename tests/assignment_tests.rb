class AssignmentTest < MiniTest::Test
  ...
  def test_assignment_name_is_unique_within_given_course_id
    ...
    assignment1 = Assignment.find_or_create_by!(course_id: 'ZZZ000', name: 'Aztec Tomb', percent_of_grade: '76', due_at: '2018-01-18 21:06:59.001', active_at: '2017-08-18 21:06:59.001') #course1.id might be suff
    assignment2 = Assignment.create(course_id: course1.id, name: 'Sword of Destiny', percent_of_grade: '81', due_at: '2018-02-18 21:06:59.001', active_at: '2017-04-18 21:06:59.001')
    assignment3 = Assignment.create(course_id: course1.id, name: 'Sword of Destiny', percent_of_grade: '66', due_at: '2019-09-18 21:06:59.001', active_at: '2018-05-18 21:06:59.001')
