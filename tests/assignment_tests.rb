class AssignmentTest < MiniTest::Test
  ...
  def test_assignment_name_is_unique_within_given_course_id
    ...
    assignment1 = Assignment.create(course_id: course1.id, name: 'Aztec Tomb', percent_of_grade: '76', due_at: '2018-01-18 21:06:59.001', active_at: '2017-08-18 21:06:59.001')
